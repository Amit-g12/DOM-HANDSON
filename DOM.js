...
document.getElementById("text").innerText = "Element for having id as text ";
...
function chngText() {
  document.querySelector("#textreplace").innerHTML ="Welcome to Elevation academy";
}
